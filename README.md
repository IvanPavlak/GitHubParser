...
- When a reviewer selects a clear range of lines (multi-line comment), only those exact lines are shown.
- When no explicit range is available, the commented line is shown with up to 5 lines of context above and below it.
